...
<div class="m-l-20 m-t-10 row" style="margin-bottom:0">
    ...
    <div class="col-sm-9 col-xs-9">
        <p class="m-b-0"><b>: <?= strtoupper($resident->lastname) ?> , <?= strtoupper($resident->firstname) ?> <?= strtoupper($resident->middlename) ?></b></p>
    </div>
</div>

<div class="m-l-15 row" style="margin-bottom:0">
    <div class="col-sm-3 col-xs-3">
...
<div class="m-l-15 row" style="margin-bottom:0">
    ...
    <div class="col-sm-9 col-xs-9">
        <p class="m-b-0"><b>: <?= date('F d, Y', strtotime($resident->birthdate)) ?></b></p>
    </div>
</div>
<div class="m-l-15 row" style="margin-bottom:0">
    <div class="col-sm-3 col-xs-3">
    ...
    <div class="col-sm-9 col-xs-9">
        <p class="m-b-0"><b>: <?= floor((time() - strtotime($resident->birthdate)) / 31556926); ?></b></p>
    </div>
</div>
