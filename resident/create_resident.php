    ...
    <form method="POST" enctype="multipart/form-data" id="resident-form">
        ...
        <div class="row m-t-30">
                ...
                <div class="row">
                    ...
                    <div class=" col-md-6">
                            <div class="form-group">
                                ...
                                <input type="tel" pattern="[0-9]{11}" class="form-control" placeholder="Enter Contact Number" name="number">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="purok">
                            <option disabled selected>Select Street Name</option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="address" required placeholder="Enter Street, Building Number, Street, barangay, Town, Province"></textarea>
            </div>
