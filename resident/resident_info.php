    ...
    <div class="col-md-9">
        <div class="white-box">
            ...
            <div class="table-responsive m-t-30">
                <table class="table table-hover table-striped" id="resinfotable">
                    <thead>
                        <tr>
                            <th>Fullname</th>
                            <th>Birthdate</th>
    ...
    <div class="col-md-3">
        ...
        <div class="row colorbox-group-widget">
            <div class="col-md-12 col-sm-12 info-color-box">
                <div class="white-box">
                    <div class="media <?= $state=='senior' ? 'bg-info' : null ?><?= $state=='voters' ? 'bg-success' : null ?><?= $state=='non-voters' ? 'bg-warning' : null ?>" 
                        <?= $state=='pwd' ? 'style="background-color:#6861ce"' : null ?>>
                ...
                <div class="col-md-12 col-sm-12 info-color-box">
                    <div class="white-box">
                        <div class="media bg-primary">
                            <div class="media-body">
                                <h3 class="info-count"><?= number_format(count($resident)) ?> 
                                <span class="pull-right"><i class="icon-people"></i></span></h3>
                ...
                <div class="col-md-12 col-sm-12 info-color-box">
                    <div class="white-box">
                        <div class="media bg-info" 
                            <?= $state=='male' ? 'style="background-color:#6861ce"' : null ?>>
                            <div class="media-body">
                                <h3 class="info-count"><?= number_format(count($male)) ?> 
                                <span class="pull-right"><i class="icon-user"></i></span></h3>
                    ...
                    <div class="white-box">
                        <div class="media bg-warning">
                            <div class="media-body">
                                ...
                                <span class="pull-right"><i class="icon-user-female"></i></span></h3>
