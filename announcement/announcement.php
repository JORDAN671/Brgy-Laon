                    ...
                    foreach ($announce as $row) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= site_url('announcement/delete/') . $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this announcement?');" data-toggle="tooltip" data-original-title="Remove">
