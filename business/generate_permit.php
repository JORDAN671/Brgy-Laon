...
<div class="text-center m-t-0">
    <h5 class="font-bold m-b-0 m-t-0"><u><?= ucwords($permit->b_name) ?></u></h5>
    <p>Company Name/Trade Name/Applicant Name</p>
    <h5 class="font-bold m-b-0 m-t-0"><u><?= ucwords($permit->owner1) ?></u></h5>
    <p>Owner/Operator/Branch Manager</p>
    <h5 class="font-bold m-b-0 m-t-0"><u><?= ucwords($permit->o_address) ?></u></h5>
    <p>Owner/s Address</p>
</div>
